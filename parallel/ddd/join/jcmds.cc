...
DDD_RET DDD_JoinEnd(const DDD::DDDContext&)
{
...
void DDD_JoinObj(const DDD::DDDContext&, DDD_HDR hdr, DDD_PROC dest, DDD_GID new_gid)
{
  JIJoin *ji;
...
void DDD_JoinBegin(const DDD::DDDContext&)
{
